...
class ListFragment : Fragment() {
    ...
    private val animalListDataOObserver = Observer<List<Animal>> { list ->
        list?.let {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.animals.observe(this, animalListDataOObserver)
        viewModel.loading.observe(this, loadingLiveDataObserver)
        viewModel.loading.observe(this, errorLiveDataObserver)
        viewModel.refresh()
